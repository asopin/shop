...
<body>
    ...
    <div class="wrap">
        ...
        $urlCartEmpty = $itemsInCart > 0 ? 'cart/list' : "#";

        // forms the top navigation menu items
        $navItems = [
            ['label' => 'Home', 'url' => ['/site/index']],
            ['label' => 'Basket ' . ($itemsInCart ? " ( $itemsInCart)" : ''), 'url' => ['cart/list']],
        ...
        <div class="container">
            <div class="col-md-2">
                ...
                // TODO: change to check a role and show to admins only
                //
                //debug
                $userClassName = new ReflectionClass(Yii::$app->user);
                Yii::trace($userClassName->getShortName());
            ...
            <div class="col-md-10">
                <!-- show content (catalog by default) -->
                <?= Breadcrumbs::widget([
