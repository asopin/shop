...
class m151112_080142_create_init_foreign_keys extends Migration
{
    public function up()
    {
        ...
        $this->addForeignKey('category_idFK', '{{%product}}', 'category_id', '{{%categories}}', 'category_id',
        'CASCADE', 'CASCADE'); // foreign key 1..∞ from product.category_id to categories.category_id
