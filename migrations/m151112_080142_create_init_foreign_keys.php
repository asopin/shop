...
class m151112_080142_create_init_foreign_keys extends Migration
{
    public function up()
    {
        ...
        $this->addForeignKey('baskets_item_idFK', '{{%baskets}}', 'item_id', '{{%product}}', 'item_id', 'CASCADE', 'CASCADE'); // foreign key 1..∞ from product.item_id to baskets.item_id
        ...
        $this->addForeignKey('images_item_idFK', '{{%images}}', 'item_id', '{{%product}}', 'item_id', 'CASCADE', 'CASCADE'); // foreign key 1..∞ from product.item_id to images.item_id
        $this->addForeignKey('category_idFK', '{{%product}}', 'category_id', '{{%categories}}', 'category_id', 'CASCADE', 'CASCADE'); // foreign key 1..∞ from product.category_id to categories.category_id
    ...
    public function down()
    {
        ...
        $this->dropForeignKey('category_idFK', '{{%product}}');
